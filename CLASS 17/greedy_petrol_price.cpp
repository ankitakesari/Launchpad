...
//Each checkpoint has a petrol pump which can be used to fill petrol in the car.
//Now cost of petrol per litre at different checkpoints is given by array C which has 0-based indexing where C[i] is the cost per litre of petrol at the ith checkpoint.
